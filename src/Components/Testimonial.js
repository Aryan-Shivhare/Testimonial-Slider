...
const Testimonial = ({reviews}) => {
    ...
    return (
        <div className="w-[85vw] rounded-md flex flex-col md:w-[700px] bg-white justify-center items-center mt-10 p-10 transition-all duration-700 hover:shadow-xl">
            <Card review={reviews[index]}></Card>
            <div className='flex text-3xl gap-3 text-violet-400 font-bold mx-auto mt-10'>
